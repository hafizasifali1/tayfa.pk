...
import { FileText, Download, Eye, Search, Filter, Edit2 } from 'lucide-react';
                ...
                {invoices.map((invoice) => (
                  <tr key={invoice.id} className="hover:bg-brand-cream/10 transition-colors group">
                    <td className="px-10 py-8">
                      <span className="font-mono text-[11px] font-bold text-brand-dark">{invoice.id.substring(0, 8)}...</span>
                    </td>
                    ...
                    <td className="px-10 py-8 text-right">
                      <div className="flex items-center justify-end space-x-3">
                        ...
                        <button className="p-2.5 bg-brand-cream/30 text-brand-dark/40 hover:text-brand-gold hover:bg-brand-cream transition-all rounded-xl border border-transparent hover:border-brand-gold/20">
                          <Eye size={16} />
                        </button>
                      </div>
                    </td>
